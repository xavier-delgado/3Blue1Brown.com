...
<Figure image="images/ExpVectorField.png" video="images/vect_anim.mp4"/>
...
<Figure video="images/rotate_anim.mp4" image="images/complex_img2.png" show="video"/>

So after pi seconds, you’ve traced a distance of pi around; $e^{i\pi} = -1$.  

<Figure image="images/e^ipi.png"/>

After $\tau = 2\pi$ seconds, you’ve gone full circle; $e^{i\tau} = 1$. 

<Figure image="images/e^itau.png"/>
